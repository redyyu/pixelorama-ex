...
func _ready() -> void:
	...
	var profile_dir = null
	if not DirAccess.dir_exists_absolute(PROFILES_PATH):
		DirAccess.make_dir_absolute(PROFILES_PATH)
		
	profile_dir = DirAccess.open(PROFILES_PATH)
	profile_dir.list_dir_begin() # TODOConverter3To4 fill missing arguments https://github.com/godotengine/godot/pull/40547
	...
	l18n_dir.list_dir_begin() # TODOConverter3To4 fill missing arguments https://github.com/godotengine/godot/pull/40547
